...
contains and what **feature type** and **attribute type** mean. The gtf file
is currently in a compressed (gzip) format, we will need to unzip it first:

```
cd ~/RNAseq_September_2018/SupplementaryMaterials/counts
